...
const coordinateFontSize = isSmallScreen ? 8 : 10
  ...
  const handleGameMove = (data: any) => {
    ...
    if (data && data.gameState) {
      ...
      if (wasFirstMove) {
        console.log("[MOVE] First move detected - using server timer values (including increment)")
        // Don't override server values - the server correctly applies increment after first move
      }
